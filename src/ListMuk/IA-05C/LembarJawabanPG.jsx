        ...
        <div style={{
            ...
            <div style={styles.container}>
                ...
                <div style={styles.questionSection}>
                    <h3 style={styles.questionTitle}>Lembar Jawaban Pertanyaan Tertulis – Pilihan Ganda:</h3>
                        ...
                        <table style={styles.answerTable}>
                            <thead>
                                <tr>
                                    ...
                                    <th style={styles.answerHeader} colSpan={2}>Pencapaian</th>
                                </tr>
                                <tr>
                                    ...
                                    <tr key={num}>
                                        ...
                                        <td style={styles.answerInputCell}>
                                            <input
                                                ...
                                                onChange={(e) => handleInputChange(`jawaban${num}`, e.target.value)}
                                            />
                                        </td>
                        ...
                        <tr>
                            ...
                            <td style={styles.feedbackContentCell}>
                                <div style={styles.feedbackHeader}>
                                    Aspek pengetahuan seluruh unit kompetensi yang diujikan<br />
                                    (tercapai/ belum tercapai)*
                                </div>
                                <textarea
                                    value={formData.aspekPengetahuan}
                                    onChange={(e) => handleInputChange('aspekPengetahuan', e.target.value)}
                                ...
                                <textarea
                                    ...
                                    onChange={(e) => handleInputChange('unitBelumTercapai', e.target.value)}
                                    style={styles.feedbackTextarea}
                ...
                <div style={styles.signatureContainer}>
                    <table style={styles.signatureTable}>
                        <tbody>
                            <tr>
                                <td style={styles.signatureTitle} colSpan={3}>Asesi :</td>
                            </tr>
                            <tr>
                                ...
                                <td style={styles.signatureInput}>
                                    <input
                                        ...
                                        onChange={(e) => handleInputChange('asesiNama', e.target.value)}
                                        style={styles.input}
                                    />
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style={styles.signatureInput}>
                                    <input
                                        ...
                                        onChange={(e) => handleInputChange('asesiTanggal', e.target.value)}
                                        style={styles.input}
                                    />
                                </td>
                            </tr>
                ...
                <div style={{ marginTop: '20px' }}>
                    <table style={styles.signatureTable}>
                        <tbody>
                            <tr>
                                <td style={styles.signatureTitle} colSpan={3}>Asesor :</td>
                            </tr>
                            <tr>
                                <td style={styles.signatureLabel}>Nama</td>
                                <td style={styles.signatureColon}>:</td>
