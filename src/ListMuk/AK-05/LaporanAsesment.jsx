          ...
          <div style={{ maxWidth: "100%", margin: "0 auto" }}>
                  ...
                  >
                    ...
                    <td style={{ border: "2px solid #ff6b35", padding: "8px" }}>
                      <input
                        ...
                        onChange={(e) =>
                          handleParticipantChange(index, "nama", e.target.value)
                        }
                        style={{
                          width: "100%",
                          border: "none",
            ...
            >
              ** Tuliskan Kode dan Judul Unit Kompetensi yang dinyatakan Bk bila
              mengesahkan satu skema Aspek Negatif dan Positif dalam Asesmen
            </div>
            ...
            >
              ...
              <div style={{ padding: "15px", backgroundColor: "white" }}>
                <textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("assessmentNotes", e.target.value)
                  }
                  style={{
                    width: "100%",
                    minHeight: "60px",
            ...
            >
              ...
              >
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("improvementPlan", e.target.value)
                  }
                  style={{
                    width: "100%",
                    minHeight: "60px",
                ...
                <tr>
                  ...
                  >
                    <div style={{ marginBottom: "8px" }}>
                      <strong style={{ color: "#ff6b35", fontSize: "12px" }}>
                        Nama:
                      </strong>
                      <input
                        type="text"
