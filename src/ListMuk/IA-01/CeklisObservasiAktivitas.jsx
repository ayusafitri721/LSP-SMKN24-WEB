...
<table style={{
  ...
  <tbody>
    <tr>
      {/* Kolom Rekomendasi */}
      <td style={{ border: "1px solid #ff6b35", padding: "12px", fontSize: "12px", verticalAlign: "top" }}>
      ...
      {/* Kolom Asesi & Asesor */}
      <td style={{ border: "1px solid #ff6b35", padding: "12px", verticalAlign: "top" }} rowSpan={2}>
        {/* Asesi */}
