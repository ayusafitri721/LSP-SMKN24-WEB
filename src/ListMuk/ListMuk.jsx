    ...
    >
      ...
      >
        <div
          style={{
            backgroundColor:
              "#fffaf8" /* Changed to a lighter orange background */,
            padding: "24px",
          ...
          >
            ...
            >
              ...
              <button
                onClick={() =>
                  onNavigate &&
                  onNavigate("listmuk/IA-01/CeklisObservasiAktivitas")
                }
                style={{
                  padding: "12px 20px",
                  fontSize: "14px",
            ...
            >
              <tbody>
                <tr>
                  ...
                  <td style={{ border: "2px solid #ff6b35", padding: "8px" }}>
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("pemrogramJunior", e.target.value)
                      }
                ...
                <tr>
                  ...
                  <td
                    style={{ border: "2px solid #ff6b35", padding: "8px" }}
                    colSpan="2"
                  >
                    <input
                      type="text"
            ...
            >
              ...
              <div style={{ padding: "15px", backgroundColor: "white" }}>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("tindakLanjut", e.target.value)
                  }
                  style={{
                    width: "100%",
                    minHeight: "60px",
                ...
                <tr>
                  ...
                  <td style={{ border: "2px solid #ff6b35", padding: "8px" }}>
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("namaAsesi2", e.target.value)
                      }
                      style={{
                        width: "100%",
                        border: "none",
                ...
                <tr>
                  ...
                  <td style={{ border: "2px solid #ff6b35", padding: "8px" }}>
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("tanggalAsesi", e.target.value)
                      }
                      style={{
                        width: "100%",
                        border: "none",
                ...
                <tr style={{ borderTop: "5px double #ff6b35" }}>
                  ...
                  <td style={{ border: "2px solid #ff6b35", padding: "8px" }}>
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("namaAsesor2", e.target.value)
                      }
                      style={{
                        width: "100%",
                        border: "none",
                ...
                <tr>
                  ...
                  <td style={{ border: "2px solid #ff6b35", padding: "8px" }}>
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("noReg", e.target.value)
                      }
                      style={{
                        width: "100%",
                        border: "none",
                ...
                <tr>
                  ...
                  <td style={{ border: "2px solid #ff6b35", padding: "8px" }}>
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("tanggalAsesor", e.target.value)
                      }
                      style={{
                        width: "100%",
                        border: "none",
