...
function Footer() {
  ...
  const handleNavigation = (path, customAction) => {
    if (customAction) {
      customAction();
    } else {
  ...
  return (
    <footer style={styles.footer}>
      ...
      <div style={styles.leftSection}>
        <h2 style={styles.title}>MyLSP</h2>
        <p style={styles.description}>
          Membantu industri menyediakan ikon bahwa produk/jasa nya telah dibuat
      ...
      <div style={styles.rightSection}>
        ...
        <div style={styles.knowMoreSection}>
          <h3 style={styles.sectionTitle}>Know More About:</h3>
          <ul
            style={{
              listStyle: "none",
              padding: 0,
