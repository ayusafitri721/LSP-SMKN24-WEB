...
function Download({ onBack }) {
  ...
  // Fungsi download ke Google Drive
  const handleDownload = () => {
    // Ganti dengan link Google Drive APK Anda
    // Format: https://drive.google.com/uc?export=download&id=FILE_ID
    const googleDriveUrl =
      "https://drive.google.com/uc?export=download&id=1your-file-id-here";

    // Atau bisa juga ke halaman preview dulu:
    // const googleDriveUrl = 'https://drive.google.com/file/d/1your-file-id-here/view';
