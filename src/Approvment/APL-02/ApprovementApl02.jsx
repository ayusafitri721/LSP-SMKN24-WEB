  ...
  const jurusanData = [
    {
      ...
      description: 'Program keahlian yang mempelajari pengembangan perangkat lunak, basis data, dan pemrograman, serta analisis sistem desktop, web, maupun mobile.',
      siswaCount: 100,
    ...
    },
    {
      id: 2,
      title: 'Perhotelan',
      description: 'Program keahlian yang mempelajari layanan hotel, tata graha, tata boga, housekeeping, dan front office hingga manajemen hotel.',
      siswaCount: 100,
      buttonText: 'Lihat Detail'
    },
    {
      id: 3,
      title: 'Tata Boga',
      description: 'Program keahlian yang mempelajari pengolahan makanan, minuman, nutrisi, menu planning, dan food presentation.',
      siswaCount: 100,
      buttonText: 'Lihat Detail'
    },
    {
      id: 4,
      title: 'Tata Busana',
      description: 'Program keahlian yang mempelajari desain, pembuatan, dan produksi pakaian, fashion design hingga tata busana.',
      siswaCount: 100,
      buttonText: 'Lihat Detail'
    },
    {
      ...
      description: 'Program keahlian yang mempelajari pelayanan perjalanan wisata, ticketing, tour guiding, serta pengelolaan usaha pariwisata.',
      siswaCount: 100,
      buttonText: 'Lihat Detail'
    }
  ];
        ...
        {jurusanData.slice(0, 4).map((jurusan) => (
          <div
            ...
            style={{
              ...
              cursor: 'pointer',
              border: selectedCard === jurusan.id ? '3px solid #ff6b35' : '3px solid transparent',
            }}
      ...
      <div style={{
        ...
        <div
          style={{
            ...
            transition: 'all 0.3s ease',
            cursor: 'pointer',
            border: selectedCard === jurusanData[4].id ? '3px solid #ff6b35' : '3px solid transparent',
